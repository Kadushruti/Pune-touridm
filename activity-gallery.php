...
if (isset($_GET['view'])) {
    $id = $_GET['view'];
       $resultsName = mysqli_query($conn, "SELECT * FROM tbl_activities WHERE id='$id'"); 
...
?>
		...
		<header class="page-header">
		    <div class="container">
		        <div class="row">
		            <div class="col-md-8">                  
		                    <h1 itemprop="name">ACTIVITY GALLERY</h1>
		            </div>
...
<div class="row gallery">
  <?php
      ...
      if(mysqli_num_rows($result) > 0)
      {
          ...
          {
              $imageURL = 'admin/uploads/activities/gallery/'.$row["file_name"];
      ?>
