...
<?php 
if (isset($_GET['destinationgallery'])) {
    $id = $_GET['destinationgallery'];
        }
?>
    <body class="fixed">
        <!-- Page Loader -->
                    ...
                    <div class="content-header row align-items-center m-0">
                        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
                            <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Destination Image Gallary</li>
                            </ol>
                        </nav>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if(mysqli_num_rows($result) > 0)
                                        {
                                            ...
                                            {
                                                $imageURL = 'uploads/destinations/gallery/'.$row["file_name"];
                                        ?>
...
{
    var destinationgallery = <?php echo $_GET['destinationgallery']?>;
   ...
   function(){ 
       window.location = 'destinationgallery.php?deleteimage='+deleteimage+'&&destinationgallery='+destinationgallery;
   }
);   
}
</script>
...
{
    $id = $_GET['deleteimage'];
    $sql1 = "DELETE FROM tbl_destinations_gallery WHERE gallery_id=$id";
    ...
    if($success1)
    {
        ...
        <script type="text/javascript">
            ...
            swal({title: "Success", text: "Image Delete Successfully..!", type: "success"},
               function(){ 
                   window.location = "destinationgallery.php?destinationgallery="+destinationgallery;
               }
            );
        </script>
<?php
...
if(isset($_POST['submit'])){ 
    $targetDir = "uploads/destinations/gallery/"; 
    ...
    if(!empty($fileNames)){ 
        foreach($_FILES['files']['name'] as $key=>$val){ 
            ...
            if(in_array($fileType, $allowTypes)){ 
                if(move_uploaded_file($_FILES["files"]["tmp_name"][$key], $targetFilePath)){  
                    $insertValuesSQL .= "('".$fileName."','".$_GET['destinationgallery']."'),"; 
                }else{ 
        ...
        if(!empty($insertValuesSQL)){ 
            ...
            $sql = "INSERT INTO tbl_destinations_gallery (file_name,destination_id) VALUES $insertValuesSQL";
