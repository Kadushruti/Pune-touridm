...
<div class="card">
    ...
    <div class="form-group row mb-3">
        <div class="col-xl-12 mb-3">
            ...
            <input type="text"  name="facility_name" required="" id="facility_name" class="form-control">
        </div>
    </div>

   <div class="mt-5 text-center">
                     <button name="addfacility" class="btn btn-lg btn-primary">
                                Add Facility
                            </button>
  </div>
...
if(isset($_POST['addfacility']))
{
    ...
    $sql = "INSERT INTO tbl_facility(facility_name) values ('$facility_name')";
